              ...
              <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-2 pt-6 text-[10.5px] text-muted-foreground flex-shrink-0">
                    <span className="flex items-center gap-1.5"><span className="w-3.5 h-3.5 rounded-sm bg-emerald-400 dark:bg-emerald-600 inline-block flex-shrink-0" />Match</span>
                    <span className="flex items-center gap-1.5"><span className="w-3.5 h-3.5 rounded-sm bg-red-400 dark:bg-red-500 inline-block flex-shrink-0" />Mismatch</span>
                    <span className="flex items-center gap-1.5"><span className="w-3.5 h-3.5 rounded-sm bg-muted inline-block flex-shrink-0" />No Step 99</span>
                  </div>
